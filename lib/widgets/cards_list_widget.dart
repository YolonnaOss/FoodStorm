    ...
    return Expanded(
      ...
      child: provider.sort != ''
          ? ListView.separated(
              ...
              itemCount: HardCodeCards.value.length,
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Stack(
                            children: [
                              Image.network(
                                HardCodeCards.value[index].image,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          HardCodeCards.value[index].cafeRating,
                                          style: TextStyle(
                                            fontSize: 12,
                              ...
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      ' -${HardCodeCards.value[index].discount.percents}%',
                                      style: TextStyle(
                                        fontFamily: ConstFont.sReg,
                                        fontSize: 20.0,
                                          ...
                                          children: [
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  '${S.of(context).start_date} ${DateFormat('dd.MM').format(DateTime.parse(HardCodeCards.value[index].createdAt))} ${S.of(context).end_date} ${DateFormat('dd.MM').format(DateTime.parse(HardCodeCards.value[index].discount.validTo))}',
                                                  style: TextStyle(
                                                    fontFamily: ConstFont.sReg,
                                                    fontSize: 14.0,
                              ...
                              Row(
                                children: [
                                  SizedBox(
                                    width: 270,
                                    child: Text(
                                      HardCodeCards.value[index].message,
                                      maxLines: 3,
                                      style: TextStyle(
                                        fontFamily: ConstFont.sReg,
                                        fontSize: 16.0,
